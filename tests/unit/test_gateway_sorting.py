...
class TestGatewaySortingAPI:
    ...
    def test_packet_repository_gateway_sorting_asc(self):
        ...
        mock_cursor.fetchone.side_effect = [
            [3],  # Total individual query (not used in new optimized logic but maybe called if fallback?)
        ]

        # Mock AGGREGATED packet records as returned by the optimized SQL query
        # Sorted ASC by gateway_count
        mock_cursor.fetchall.return_value = [
            ...
            # Group 3: mesh_packet_id "ghi789" - 3 gateways
            {
                ...
                "channel_id": "LongFast",
                "gateway_count": 3,
                "gateway_list": "!433d0c24,!da73e9cc,!12345678",
                "min_rssi": -85,
                "max_rssi": -65,
                "min_snr": 3,
                "max_snr": 12,
        ...
        # The new code dedups and sorts the gateway list string
    ...
    def test_packet_repository_gateway_sorting_desc(self):
        ...
        # Mock AGGREGATED packet records sorted DESC by gateway_count
        mock_cursor.fetchall.return_value = [
            # Group 3: mesh_packet_id "ghi789" - 3 gateways
            {
                "id": 4,
